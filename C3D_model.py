...
def C3D(input, num_classes, keep_pro=0.5):
    with tf.variable_scope('C3D'):
        with slim.arg_scope([slim.conv3d],
            ...
            net = slim.fully_connected(net, 1024, weights_regularizer=slim.l2_regularizer(0.0005), scope='fc6')
            ...
            net = slim.fully_connected(net, 1024, weights_regularizer=slim.l2_regularizer(0.0005), scope='fc7')
